...
const resources = {
  en: {
    translation: {
      ...
      dramaTheaterDescription: "The Tomsk Regional Drama Theater is one of the oldest in Siberia: the first theater building was built in 1850. The activities of the Tomsk drama are inextricably linked with the life and development of the city - a well-known university and cultural center in the country.",
      ...
      kemerovoTheaterTitle: "Kemerovo Regional Drama Theater named after A. V. Lunacharsky in Kemerovo",
      kemerovoTheaterDescription: "The history of the Kemerovo Regional Drama Theater began on November 1, 1934. At that time, the State Drama Theater 'Cultarmeyets Kuzbassa' opened the first theater season with the play 'The Death of the Squadron' based on the play by Alexander Korneichuk, directed by Alexey Larionov.",
      readMore: "Read more",
      ...
      guarantees: [
        ...
        },
        {
          ...
          description: "We offer a wide variety of personally picked tours around the globe.",
        },
        {
          icon: '/assets/img/star.svg',  
          title: "Highly Qualified Service",
          description: "Our tour managers are qualified, skilled, and friendly to provide you with the best service.",
        },
        {
        ...
        },
        {
          ...
          description: "If you find tours cheaper than ours, we will compensate the difference.",
        },
      ],
    ...
    showEveryCorner: "We'll show every corner of the city without going in circles",
  ...
  ru: {
    translation: {
      ...
      dramaTheaterDescription: "Томский областной театр драмы - один из старейших в Сибири...",
      galileoParkTitle: "Парк Чудес Галилео в Новосибирске",
      galileoParkDescription: "\"Парк чудес Галилео\" в Новосибирске - это удивительный интерактивный музей...",
      kemerovoTheaterTitle: "Кемеровский областной театр драмы имени А. В. Луначарского в Кемерово",
      kemerovoTheaterDescription: "История Кемеровского областного театра драмы началась 1 ноября 1934 года...",
