            ...
            <div className="populyar__big-box">
                ...
                <div className="populyar__block">
                    <div className="populyar__box">
                        <Link to="/attractions">
                            <img
                                className="populyar__item"
                                src={`${process.env.PUBLIC_URL}/assets/img/Novosibirsk.png`}
                                alt={t("novosibirsk")}
                            />
                        </Link>
                    ...
                    <div className="populyar__box">
                        <Link to="/attractions">
                            <img
                                className="populyar__item"
                                src={`${process.env.PUBLIC_URL}/assets/img/Tomsk.jpg`}
                                alt={t("tomsk")}
                            />
                        </Link>
                    ...
                    <div className="populyar__box">
                        <Link to="/attractions">
                            <img
                                className="populyar__item"
                                src={`${process.env.PUBLIC_URL}/assets/img/Kemerovo.jpg`}
                                alt={t("kemerovo")}
                            />
                        </Link>
