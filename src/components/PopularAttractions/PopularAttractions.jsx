        ...
        <section className="infoHome">
            ...
            <div className="info__main">
                <div className="info__box-img">
                    <img
                        className="info__img"
                        src={`${process.env.PUBLIC_URL}/assets/img/teatr.png`}
                        alt={t("dramaTheaterTitle")}
                    />
                </div>
            ...
            <div className="info__main">
                <div className="info__box-img">
                    <img
                        className="info__img"
                        src={`${process.env.PUBLIC_URL}/assets/img/galileo.jpg`}
                        alt={t("galileoParkTitle")}
                    />
                </div>
                <div className="info__box">
            ...
            <div className="info__main">
                <div className="info__box-img">
                    <img
                        className="info__img"
                        src={`${process.env.PUBLIC_URL}/assets/img/teatr2.jpg`}
                        alt={t("kemerovoTheaterTitle")}
                    />
                </div>
                <div className="info__box">
                    <div className="info__title">
                        {t("kemerovoTheaterTitle")}
                    </div>
                    <p className="info__text">
                        {t("kemerovoTheaterDescription")}
                    </p>
                    <button className="info__btn">
                        <a href="/sight/attraction.html">{t("readMore")}</a>
                    </button>
